...
function enviarPagoFacil3dSecure(ambiente){

    var campos = $( "co-payment-form" ).serialize();

    //Se ordenan los campos para el envío
    var res = campos.replace(/payment%5B/g, "");
    var dres = res.replace(/%5D/g, "");
